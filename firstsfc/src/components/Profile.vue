        ...
        <div class="row align-items-center bg-white p-5 rounded shadow-sm">
          ...
          <div class="col-lg-8">
            ...
            <p class="text-secondary lh-lg">
              ...
              manga, manhwa, and light novels, which fuel my creativity and imagination. As a naturally curious
              person, I love exploring new ideas and continuously learning about different subjects to broaden
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="timeline">
              ...
              <div class="timeline-item">
                <span class="timeline-year">2008 - 2011</span>
                <h3 class="timeline-school">Pasay City North High School - Annex</h3>
                <p class="timeline-degree">Junior High School</p>
              </div>
              <div class="timeline-item">
                <span class="timeline-year">2003 - 2008</span>
                <h3 class="timeline-school">Cuneta Elementary School</h3>
                <p class="timeline-degree">Primary Education</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row g-4">
          <div class="col-md-4" v-for="(img, index) in projectImages" :key="index">
            <div
              class="card h-100 shadow-sm border-0 project-card cursor-pointer"
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            <div class="card p-4 shadow border-0 bg-light">
              <div v-if="guestbook.submitted" class="alert alert-success">
                Thanks, {{ guestbook.name }}! Your comment has been posted.
              </div>
    ...
    <footer class="text-center py-5 mt-auto text-white">
      <div class="container">
        ...
        <div class="mb-4 social-icons">
          <a href="https://www.linkedin.com/in/beejay-carpio-b01947322" target="_blank" class="mx-2 text-white">
            <i class="bi bi-linkedin fs-4"></i>
          </a>
          <a href="https://www.github.com/Suppelong" target="_blank" class="mx-2 text-white">
